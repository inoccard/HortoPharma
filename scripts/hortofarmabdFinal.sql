...
--
-- Host: 127.0.0.1
-- Generation Time: 22-Jun-2018 às 01:27
...
INSERT INTO `farmaceutico` (`CODFARMACEUTICO`, `LOGIN`, `SENHA`, `CARGO`, `NIVEL_ACESSO`) VALUES
(1, 'inoccard', '123', 'Gerente', 0),
(2, 'weverton', '234', 'Atendende', 1),
(3, 'inocencio', '123', 'Estoquista', 2),
(4, 'inoccardoso', '1234', 'Atendende 2', 0);
...
(13, 'Hallan Dias da Silv', '323.148.748-12', NULL, NULL, '2018-06-07', NULL, NULL),
(14, 'Weverton Santos', '324.344.444-53', NULL, NULL, '2018-06-07', NULL, NULL),
(15, 'novo cliente', '333.333.333-33', NULL, NULL, '2018-06-17', NULL, NULL);
...
(10, 'unicampp', '45.344.359/3480-30'),
(11, 'Unasp ht', '23.435.364/7456-36');
...
(10, 2, 2, 1, '30.81', '0.00', '30.81'),
(11, 2, 4, 1, '30.81', '0.00', '30.81'),
(12, 1, 4, 1, '20.99', '1.89', '19.10');
...
(1, 'Xarope', '11.98', '20.99', 1, 1, '9.00'),
(2, 'Metamizol', '25.82', '30.81', 3, 2, '0.00'),
(3, 'Mel Pret', '10.78', '30.78', 0, 1, '8.00'),
(4, 'Xarope', '2.90', '4.80', 0, 1, '7.00'),
(5, 'hhhhhh', '8.90', '9.90', 0, 1, '0.00');
...
(2, 12, '2018-06-10', '102.17', 2),
(3, 14, '2018-06-10', '14.02', 2),
(4, 13, '2018-06-14', '49.91', 1);
...
ALTER TABLE `farmaceutico`
  ...
  ADD UNIQUE KEY `EMAIL_UNIQUE` (`CARGO`),
...
--
ALTER TABLE `tbcompra`
  MODIFY `CODCOMPRAS` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `tbdoencas`
--
ALTER TABLE `tbdoencas`
  MODIFY `CODDOENCAS` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tbfornecedor`
--
ALTER TABLE `tbfornecedor`
  MODIFY `CODFORNECEDOR` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `tbvenda`
  MODIFY `CODVENDAS` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
