...
--
-- Host: 127.0.0.1
-- Generation Time: 13-Jun-2018 às 20:14
...
(1, 'Inocêncio Cardoso', '121.211.122-33', NULL, NULL, '1999-06-13', NULL, NULL);
...
INSERT INTO `tbdoencas` (`coddoencas`, `CODIGOCLIENTE`, `nome`) VALUES
(1, 1, 'CRONICA'),
(2, 1, 'ALERGIA');
