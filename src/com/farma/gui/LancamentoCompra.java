...
import com.farma.bean.ItemCompra;
import com.farma.bean.Produto;
import com.farma.bean.enums.Situacao;
import com.farma.dao.CompraDAO;
import com.farma.gui.table.CompraTableModel;
import com.farma.gui.table.ItemCompraTableModel;
...
public class LancamentoCompra extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btSalvar.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/com/farma/gui/img/salvar-foco.png"))); 
        ...
        btFinalizar.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/com/farma/gui/img/finalizar-foco.png"))); 
        ...
        btExcluir.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/com/farma/gui/img/excluir-foco.png"))); 
        ...
        btCancelar.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/com/farma/gui/img/cancelar-foco.png"))); 
        ...
        pnForm.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createEmptyBorder(5, 0, 5, 0), 
        		javax.swing.BorderFactory.createTitledBorder(null, "Formulário", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, 
        				javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(102, 153, 255)))); 
        ...
        btFornecedor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/farma/gui/img/buscar.png"))); 
        ...
        btFornecedor.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/com/farma/gui/img/buscar-foco.png"))); 
        ...
        pnFormItens.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createEmptyBorder(5, 0, 5, 0), 
        		javax.swing.BorderFactory.createTitledBorder(null, "Formulário", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, 
        		javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(102, 153, 255)))); 
        ...
        lbValorUnitario.setText("Valor UnitÃ¡rio:");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_END;
        ...
        btProduto.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/com/farma/gui/img/buscar-foco.png"))); 
        ...
        btAdicionarItem.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/com/farma/gui/img/novo-foco.png"))); 
        ...
        btRemoverItem.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/com/farma/gui/img/excluir-foco.png"))); 
    ...
    public void setProduto(Produto produto) {
        ...
        ftfValorUnitario.setValue((double)produto.getPrecoCompra());
    }
    ...
    private void salvar(boolean finalizar) {
        if (validarFormulario()) {
            ...
            if (finalizar) {
                compra.setSituacao(Situacao.FINALIZADA.getId());
            } else {
                compra.setSituacao(Situacao.ABERTA.getId());
            }
